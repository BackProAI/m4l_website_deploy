...
Test Section 4_2 Implementation
Uses all existing rules + arrow replacement + NEW no-change rule
"""
...
class Section4_2Tester:
    def __init__(self, pdf_path=None):
        self.section_name = "Section_4_2"
        
        # Make test directory relative to the project root
        project_root = os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__))))
        self.test_dir = os.path.join(project_root, "data", "test_sections", "section_4_2_test")
    ...
    def load_extracted_image(self) -> str:
        ...
        try:
            ...
            image_filename = f"section_4_2_extracted.png"
    ...
    def analyze_with_gpt4o(self, image_path: str) -> dict:
        ...
        try:
            ...
            prompt = ref_impl.get_section_4_2_analysis_prompt()
    ...
    def save_analysis_results(self, analysis_data: dict):
        ...
        try:
            analysis_file = os.path.join(self.test_dir, "section_4_2_analysis.json")
    ...
    def run_analysis_only(self, progress_callback=None):
        ...
        print(f"Starting Section_4_2 Analysis")
        ...
        print(f"📊 Step 1: Loading PDF and cutting Section_4_2...")
        section_image_path = self.load_extracted_image()
        if not section_image_path:
            print(f"❌ Section_4_2 Analysis Failed!")
            return False
        ...
        print(f"🧠 Step 2: Analyzing Section_4_2 with GPT-4o...")
        ...
        print(f"🎉 Section_4_2 Analysis Complete!")
        return True
    
    def run_test(self):
        """Run the complete Section 4_2 test"""
        print("🚀 Starting Section 4_2 Test (All rules + Arrow replacement + No-change rule)")
        print("📄 Test section: Section 4_2 - PNG image analysis only")
        print("🔍 Section: Section_4_2")
        print("=" * 80)
        
        # Step 1: Load PDF and cut section
        print("📊 Step 1: Loading PDF and cutting Section_4_2...")
        section_image_path = self.load_extracted_image()
        if not section_image_path:
            return
        print(f"✅ Section image loaded: {section_image_path}")
        ...
        # Step 2: Analyze with GPT-4o
        print("🧠 Step 2: Analyzing Section_4_2 with GPT-4o...")
        analysis_result = self.analyze_with_gpt4o(section_image_path)
        
        # Save analysis for inspection
        analysis_output_path = f"{self.test_dir}/section_4_2_analysis.json"
...
def main():
    ...
    parser = argparse.ArgumentParser(description="4 2 Tester")
    ...
    tester = Section4_2Tester(pdf_path=args.pdf_path)
